...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    ftp: {
      ...
      upload1: {
        files: {
          '/17200/experiments/usatoday/2015/03/womens-history/': 'js/main.js'
        }
      },
      upload2: {
        files: {
          '/17200/experiments/usatoday/2015/03/womens-history/': 'style/project.css'
        }
      },
      upload3: {
        files: {
          '/17200/experiments/usatoday/2015/03/womens-history/': 'data/*.json'
        }
      }
    },
